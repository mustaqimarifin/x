...
function AnimatedBars() {
  ...
  return (
    <div className="flex w-auto items-end overflow-hidden">
      <span
        id="bar1"
        className="mr-[3px] h-2 w-1 bg-pink-300 opacity-75 dark:bg-gray-500"
      />
      <span
        id="bar2"
        className="mr-[3px] h-1 w-1 bg-rose-300 dark:bg-gray-500"
      />
      <span
        id="bar3"
        className="h-3 w-1 bg-rose-400 opacity-80 dark:bg-gray-500"
      />
    </div>
  );
}
  ...
  return (
    <div className="mb-8 flex w-full flex-row-reverse items-center space-x-0 align-baseline sm:flex-row sm:space-x-2">
      ...
      <div className="inline-flex w-full max-w-full flex-col truncate sm:flex-row ">
        ...
        <span className="mx-2 hidden text-sm text-gray-500 dark:text-gray-300 sm:block">
          {" – "}
        </span>
