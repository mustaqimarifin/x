const id = "05-astro-sphere-writing-mdx/index.mdx";
						...
						const data = {title:"Astro Sphere: Writing MDX",summary:"Lorem ipsum dolor sit amet",date:new Date(1710172800000),tags:["Tutorial","Astro","Astro Sphere","Markdown","MDX"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "/home/oddjobs/projects/x/src/content/blog/05-astro-sphere-writing-mdx/index.mdx",
							rawData: undefined,
						};
