import { c as createAstro, b as createComponent, r as renderTemplate, m as maybeRenderHead, k as renderSlot, a4 as __astro_tag_component__, a5 as Fragment, _ as createVNode } from './astro_CFKn3T1_.mjs';
import { $ as $$Image } from './pages/generic_BXgdFctm.mjs';
import { ssr, ssrHydrationKey, escape, createComponent as createComponent$1 } from 'solid-js/web';
import { createSignal, createResource, createEffect, Show, Switch, Match } from 'solid-js';
...
}, "/home/vmp/Projects/x50/src/content/blog/05-astro-sphere-writing-mdx/MyComponent.astro", void 0);

var _tmpl$ = ["<div", ">Count limit reached</div>"], _tmpl$2 = ["<p", ">Loading...</p>"], _tmpl$3 = ["<div", ">", "</div>"], _tmpl$4 = ["<div", "><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></div>"];
...
const file = "/home/vmp/Projects/x50/src/content/blog/05-astro-sphere-writing-mdx/index.mdx";
...
Content.moduleId = "/home/vmp/Projects/x50/src/content/blog/05-astro-sphere-writing-mdx/index.mdx";
