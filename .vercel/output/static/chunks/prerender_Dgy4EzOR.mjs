import {
  ...
  r as renderUniqueStylesheet,
  a as renderScriptElement,
  b as createHeadAndContent,
  d as renderTemplate,
...
import { p as prependForwardSlash } from "./astro/assets-service_D9b0zSGQ.mjs";
/* empty css                          */
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({
  "/src/content/blog/01-astro-sphere-file-structure/index.md": () =>
    import("./index_BFIHqS68.mjs"),
  "/src/content/blog/02-astro-sphere-getting-started/index.md": () =>
    import("./index_BHugBb8V.mjs"),
  "/src/content/blog/03-astro-sphere-add-new-post-or-projects/index.md": () =>
    import("./index_BhV1jXOS.mjs"),
  "/src/content/blog/04-astro-sphere-writing-markdown/index.md": () =>
    import("./index_DLOrxP66.mjs"),
  "/src/content/blog/05-astro-sphere-writing-mdx/index.mdx": () =>
    import("./index_DXw4mX8m.mjs"),
  "/src/content/blog/06-astro-sphere-social-links/index.md": () =>
    import("./index_BVLoFNzC.mjs"),
  "/src/content/legal/privacy.md": () => import("./privacy_cG8FGS2L.mjs"),
  "/src/content/legal/terms.md": () => import("./terms_zUptzAIL.mjs"),
  "/src/content/projects/project-1/index.md": () =>
    import("./index_CZj2pH73.mjs"),
  "/src/content/projects/project-2/index.md": () =>
    import("./index_cG6I2KdY.mjs"),
  "/src/content/projects/project-3/index.md": () =>
    import("./index_lxaQMI29.mjs"),
  "/src/content/projects/project-4/index.md": () =>
    import("./index_CZD_E37g.mjs"),
  "/src/content/work/apple.md": () => import("./apple_DUUaxWku.mjs"),
  "/src/content/work/facebook.md": () => import("./facebook_DXfn1Wi9.mjs"),
  "/src/content/work/google.md": () => import("./google_YKxnQbAz.mjs"),
  "/src/content/work/mcdonalds.md": () => import("./mcdonalds_Bxl-l3W7.mjs"),
});
...
lookupMap = {
  ...
  work: {
    type: "content",
    entries: {
      apple: "/src/content/work/apple.md",
      facebook: "/src/content/work/facebook.md",
      google: "/src/content/work/google.md",
      mcdonalds: "/src/content/work/mcdonalds.md",
    },
  },
  blog: {
    type: "content",
  ...
  projects: {
    type: "content",
    entries: {
      "project-1": "/src/content/projects/project-1/index.md",
      "project-2": "/src/content/projects/project-2/index.md",
      "project-3": "/src/content/projects/project-3/index.md",
      "project-4": "/src/content/projects/project-4/index.md",
    },
  },
};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({
  "/src/content/blog/01-astro-sphere-file-structure/index.md": () =>
    import("./index_DfCt8mld.mjs"),
  "/src/content/blog/02-astro-sphere-getting-started/index.md": () =>
    import("./index_gWCBPJjb.mjs"),
  "/src/content/blog/03-astro-sphere-add-new-post-or-projects/index.md": () =>
    import("./index_VFd-0ykc.mjs"),
  "/src/content/blog/04-astro-sphere-writing-markdown/index.md": () =>
    import("./index_0zaIpSNi.mjs"),
  "/src/content/blog/05-astro-sphere-writing-mdx/index.mdx": () =>
    import("./index_BNd__rfL.mjs"),
  "/src/content/blog/06-astro-sphere-social-links/index.md": () =>
    import("./index_Bd4DuJY5.mjs"),
  "/src/content/legal/privacy.md": () => import("./privacy_C9YEkHVs.mjs"),
  "/src/content/legal/terms.md": () => import("./terms_BfSJFF33.mjs"),
  "/src/content/projects/project-1/index.md": () =>
    import("./index_Djm1ZGCY.mjs"),
  "/src/content/projects/project-2/index.md": () =>
    import("./index_C0gygzTw.mjs"),
  "/src/content/projects/project-3/index.md": () =>
    import("./index_CizKf2SW.mjs"),
  "/src/content/projects/project-4/index.md": () =>
    import("./index_u5LvhlCz.mjs"),
  "/src/content/work/apple.md": () => import("./apple_DjBm9nPi.mjs"),
  "/src/content/work/facebook.md": () => import("./facebook_W1GcZI5W.mjs"),
  "/src/content/work/google.md": () => import("./google_B0GBjjfL.mjs"),
  "/src/content/work/mcdonalds.md": () => import("./mcdonalds_CBtxyYz4.mjs"),
});
...
const $$ViewTransitions = createComponent(
  ...
  "/home/vmp/Projects/x50/node_modules/.pnpm/astro@4.5.12_typescript@5.4.3/node_modules/astro/components/ViewTransitions.astro",
  void 0,
);
...
const $$BaseHead = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate(
      _a$2 ||
        (_a$2 = __template$2([
          '<!-- Global Metadata --><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"',
          '><!-- <link rel="preload" href="/fonts/atkinson-regular.woff" as="font" type="font/woff" crossorigin>\n<link rel="preload" href="/fonts/atkinson-bold.woff" as="font" type="font/woff" crossorigin> --><!-- Canonical URL --><link rel="canonical"',
          "><!-- Primary Meta Tags --><title>",
          '</title><meta name="title"',
          '><meta name="description"',
          '><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url"',
          '><meta property="og:title"',
          '><meta property="og:description"',
          '><meta property="og:image"',
          '><!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"',
          '><meta property="twitter:title"',
          '><meta property="twitter:description"',
          '><meta property="twitter:image"',
          '><!-- Sitemap --><link rel="sitemap" href="/sitemap-index.xml"><!-- RSS Feed --><link rel="alternate" type="application/rss+xml"',
          "",
          '><!-- Global Scripts --><script src="/js/theme.js"></script><script src="/js/scroll.js"></script><script src="/js/animate.js"></script><script src="/js/top.js"></script>',
          "",
        ])),
      ...
      addAttribute(Astro2.url, "content"),
      addAttribute(title, "content"),
      addAttribute(description, "content"),
      addAttribute(new URL(image, Astro2.url), "content"),
      addAttribute(Astro2.url, "content"),
      addAttribute(title, "content"),
      addAttribute(description, "content"),
      addAttribute(new URL(image, Astro2.url), "content"),
  ...
  "/home/vmp/Projects/x50/src/components/BaseHead.astro",
  void 0,
);
...
const SITE = {
  ...
  DESCRIPTION:
    "Welcome to My Ass, a portfolio and blog for designers and developers.",
...
const $$Container = createComponent(
  ...
  "/home/vmp/Projects/x50/src/components/Container.astro",
  void 0,
);
...
const $$Header = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate(
      ...
      renderComponent(
        ...
        "Container",
        $$Container,
        { size: "md", "data-astro-cid-3ef6ksr2": true },
        {
          default: ($$result2) =>
  ...
  "/home/vmp/Projects/x50/src/components/Header.astro",
  void 0,
);
...
const $$Footer = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    Astro2.self = $$Footer;
    return renderTemplate`${maybeRenderHead()}<footer class="relative bg-white dark:bg-black"> <div class="animate"> <section class="py-5"> ${renderComponent(
      $$result,
      "Container",
      $$Container,
      { size: "md" },
...
Back to top
      ...
      { size: "md" },
      {
        default: (
          $$result2,
        ) => renderTemplate` <div class="h-full grid grid-cols-1 sm:grid-cols-2 gap-3"> <div class="order-2 sm:order-1 flex flex-col items-center justify-center sm:items-start"> <div class="legal"> <a href="/legal/terms" class="text-current hover:text-black dark:hover:text-white transition-colors duration-300 ease-in-out">
Terms
</a> |
...
&copy; 2024 | All rights reserved
  ...
  "/home/vmp/Projects/x50/src/components/Footer.astro",
  void 0,
);
...
const $$Drawer = createComponent(
  ...
  "/home/vmp/Projects/x50/src/components/Drawer.astro",
  void 0,
);
...
const $$PageLayout = createComponent(
  ...
  "/home/vmp/Projects/x50/src/layouts/PageLayout.astro",
  void 0,
);
...
const $$TopLayout = createComponent(
  ...
  "/home/vmp/Projects/x50/src/layouts/TopLayout.astro",
  void 0,
);
...
const $$BottomLayout = createComponent(
  ...
  "/home/vmp/Projects/x50/src/layouts/BottomLayout.astro",
  void 0,
);
...
var _tmpl$$4 = [
    "<a",
    ' href="',
    '" class="group p-4 gap-3 flex items-center border rounded-lg hover:bg-black/5 hover:dark:bg-white/10 border-black/15 dark:border-white/20 transition-colors duration-300 ease-in-out"><div class="w-full group-hover:text-black group-hover:dark:text-white blend"><div class="flex flex-wrap items-center gap-2"><!--$-->',
    '<!--/--><div class="font-mono tabular-nums text-xs uppercase">',
    '</div></div><div class="font-semibold mt-3 text-black dark:text-white">',
    '</div><div class="text-sm line-clamp-2">',
    '</div><ul class="flex flex-wrap mt-2 gap-1 text-xs font-bold font-mono uppercase">',
    '</ul></div><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="stroke-current group-hover:stroke-black group-hover:dark:stroke-white"><line x1="5" y1="12" x2="19" y2="12" class="scale-x-0 group-hover:scale-x-100 translate-x-4 group-hover:translate-x-1 transition-all duration-300 ease-in-out"></line><polyline points="12 5 19 12 12 19" class="translate-x-0 group-hover:translate-x-1 transition-all duration-300 ease-in-out"></polyline></svg></a>',
  ],
  _tmpl$2$4 = [
    "<div",
  ...
  _tmpl$3$3 = [
    "<li",
    ' class=" py-0.5 px-1 rounded bg-black/5 dark:bg-white/20 text-black/75 dark:text-white/75">',
    "</li>",
  ];
function ArrowCard({ entry, pill }) {
  const { collection, data, slug } = entry;
  const { title, summary, date, tags } = data;
  return ssr(
    _tmpl$$4,
    ssrHydrationKey(),
    `/${escape(collection, true)}/${escape(slug, true)}`,
    pill &&
      ssr(
        _tmpl$2$4,
        ssrHydrationKey(),
    ...
    escape(title),
    escape(summary),
    escape(tags.map((tag) => ssr(_tmpl$3$3, ssrHydrationKey(), escape(tag)))),
  );
}

var _tmpl$$3 = [
    "<div",
    ' class="w-full grid grid-cols-1 sm:grid-cols-2 gap-6"><div class="sm:col-span-2"><div class="flex flex-col"><div class="text-sm uppercase mb-2">SHOWING <!--$-->',
    "<!--/--> OF <!--$-->",
    '<!--/--> POSTS</div><ul class="flex flex-col gap-3">',
    "</ul></div></div></div>",
  ],
  _tmpl$2$3 = ["<li", ">", "</li>"];
function Blog({ data }) {
...
const $$Index$4 = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/blog/index.astro",
  void 0,
);
...
const $$ViewCounter = createComponent(
  async ($$result, $$props, $$slots) => {
  ...
  "/home/vmp/Projects/x50/src/components/ViewCounter.astro",
  void 0,
);

const $$Astro$a = createAstro("https://mstqmarfn.vercel.app");
const $$ArticleTopLayout = createComponent(
  async ($$result, $$props, $$slots) => {
...
Back to ${collection} </div> </a> <div class="flex flex-wrap text-sm uppercase mt-12 gap-3 opacity-75"> <div class="flex items-center gap-2"> <svg class="size-5 stroke-current"> <use href="/ui.svg#calendar"></use> </svg> ${formatDate(date)} </div> ${renderComponent($$result, "ViewCounter", $$ViewCounter, { "client:load": true, slug: slug, "client:component-hydration": "load", "client:component-path": "@components/ViewCounter.astro", "client:component-export": "default" })} <div class="flex items-center gap-2"> <svg class="size-5 stroke-current"> <use href="/ui.svg#book-open"></use> </svg> ${readingTime(body)} </div> </div> <h1 class="text-3xl font-semibold text-black dark:text-white mt-2"> ${title} </h1> <div class="mt-1"> ${summary} </div> ${
      (demoUrl || repoUrl) &&
      renderTemplate`<div class="mt-4 flex flex-wrap gap-2"> ${
        demoUrl &&
        renderTemplate`<a${addAttribute(demoUrl, "href")} target="_blank" class="group flex gap-2 items-center px-3 py-1.5 truncate rounded text-xs md:text-sm lg:text-base border border-black/25 dark:border-white/25 hover:bg-black/5 hover:dark:bg-white/15 blend"> <svg class="size-4"> <use href="/ui.svg#globe" class="fill-current group-hover:fill-black group-hover:dark:fill-white blend"></use> </svg> <span class="text-current group-hover:text-black group-hover:dark:text-white blend">
See Demo
</span> </a>`
      } ${
        repoUrl &&
        renderTemplate`<a${addAttribute(repoUrl, "href")} target="_blank" class="group flex gap-2 items-center px-3 py-1.5 truncate rounded text-xs md:text-sm lg:text-base border border-black/25 dark:border-white/25 hover:bg-black/5 hover:dark:bg-white/15 blend"> <svg class="size-4"> <use href="/ui.svg#link" class="fill-current group-hover:fill-black group-hover:dark:fill-white blend"></use> </svg> <span class="text-current group-hover:text-black group-hover:dark:text-white blend">
See Repository
</span> </a>`
      } </div>`
    } </div>`;
  },
  "/home/vmp/Projects/x50/src/layouts/ArticleTopLayout.astro",
  void 0,
);

const $$Astro$9 = createAstro("https://mstqmarfn.vercel.app");
const $$ArticleBottomLayout = createComponent(
  async ($$result, $$props, $$slots) => {
...
Next
  ...
  "/home/vmp/Projects/x50/src/layouts/ArticleBottomLayout.astro",
  void 0,
);
...
const $$$2 = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/blog/[...slug].astro",
  void 0,
);
...
const ____slug_$2 = /*#__PURE__*/ Object.freeze(
  /*#__PURE__*/ Object.defineProperty(
    {
      __proto__: null,
      default: $$$2,
...
const $$StackCard = createComponent(
  async ($$result, $$props, $$slots) => {
  ...
  "/home/vmp/Projects/x50/src/components/StackCard.astro",
  void 0,
);

var _tmpl$$2 = ["<div", ' class="text-xs uppercase">', "</div>"],
  _tmpl$2$2 = [
    "<a",
    ' href="',
    '" class="group gap-3 flex items-center rounded-lg hover:bg-black/5 hover:dark:bg-white/10 transition-colors duration-300 ease-in-out"><div class="w-full group-hover:text-black group-hover:dark:text-white blend"><div class="flex items-center align-middle gap-2"><!--$-->',
    '<!--/--><span class="font-semibold text-black dark:text-white">',
    "</span><span>",
    "</span></div></div></a>",
  ],
  _tmpl$3$2 = ["<div", ' class="text-sm capitalize px-2 py-0.5 ">', "</div>"];
function PostList({ entry, pill }) {
  const fDate = () =>
    ssr(_tmpl$$2, ssrHydrationKey(), escape(formatDate(entry.data.date)));
  return ssr(
    _tmpl$2$2,
    ssrHydrationKey(),
    `/${escape(entry.collection, true)}/${escape(entry.slug, true)}`,
    pill &&
      ssr(
        _tmpl$3$2,
        ssrHydrationKey(),
...
const $$Index2 = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      "PageLayout",
      $$PageLayout,
      { title: "Home", description: SITE.DESCRIPTION },
      {
        default: (
          $$result2,
        ) => renderTemplate`  ${maybeRenderHead()}<div class="absolute inset-0 block dark:hidden"> <div id="particles1" class="fixed inset-0"></div> <div id="particles2" class="fixed inset-0"></div> <div id="particles3" class="fixed inset-0"></div> </div>  <div class="absolute inset-0 bg-black hidden dark:block"> <div id="stars1" class="fixed inset-0"></div> <div id="stars2" class="fixed inset-0"></div> <div id="stars3" class="fixed inset-0"></div> </div>   <section class="relative h-screen w-full"> <!--     <div id="planetcont" class='animate absolute inset-0 top-1/4 overflow-hidden'>
...
Reach out to me via email or on social media.
</p> <div class="grid grid-cols-4 gap-y-2 mt-4 auto-cols-min"> ${SOCIALS.map(
          (
            social,
          ) => renderTemplate`<div class="col-span-1 flex items-center gap-1"> <span class="whitespace-nowrap truncate"> ${social.NAME} </span> </div>
  ...
  "/home/vmp/Projects/x50/src/pages/index2.astro",
  void 0,
);
...
const $$$1 = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      "PageLayout",
      $$PageLayout,
      { title: title, description: `${title} for ${SITE.TITLE}` },
      {
        default: ($$result2) =>
          renderTemplate` ${renderComponent(
            $$result2,
            ...
            {},
            {
              default: (
                $$result3,
              ) => renderTemplate` ${maybeRenderHead()}<div class="animate"> <div class="page-heading"> ${title} </div> <p class="font-normal opacity-75">
Last updated: ${formatDate(date)} </p> </div> `,
            },
          )} ${renderComponent($$result2, "BottomLayout", $$BottomLayout, {}, { default: ($$result3) => renderTemplate` <article class="animate"> ${renderComponent($$result3, "Content", Content, {})} </article> ` })} `,
      },
    )}`;
  },
  "/home/vmp/Projects/x50/src/pages/legal/[...slug].astro",
  void 0,
);
...
var _tmpl$$1 = [
    "<div",
    ' class="grid grid-cols-1 sm:grid-cols-3 gap-6"><div class="col-span-3 sm:col-span-1"><div class="sticky top-24"><div class="text-sm font-semibold uppercase mb-2 text-black dark:text-white">Filter</div><ul class="flex flex-wrap sm:flex-col gap-1.5">',
    '</ul></div></div><div class="col-span-3 sm:col-span-2"><div class="flex flex-col"><div class="text-sm uppercase mb-2">SHOWING <!--$-->',
    "<!--/--> OF <!--$-->",
    '<!--/--> PROJECTS</div><ul class="flex flex-col gap-3">',
    "</ul></div></div></div>",
  ],
  _tmpl$2$1 = [
    "<li",
      ...
      createComponent$1(For, {
        ...
        children: (tag) =>
          ssr(
            ...
            ssrAttribute(
              "class",
              escape(cn(!filter().has(tag) ? "block" : "hidden"), true),
              false,
            ),
            `/ui.svg#square-check`,
            ssrAttribute(
...
const $$Index$3 = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/projects/index.astro",
  void 0,
);
...
const $$ = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/projects/[...slug].astro",
  void 0,
);
...
const robots_txt = /*#__PURE__*/ Object.freeze(
  /*#__PURE__*/ Object.defineProperty(
    {
      __proto__: null,
      GET: GET$1,
...
var _tmpl$ = [
    "<div",
    ' class="flex flex-col"><div class="relative"><input name="search" type="text"',
    ' autocomplete="off" spellcheck="false" placeholder="What are you looking for?" class="w-full px-2.5 py-1.5 pl-10 rounded outline-none text-black dark:text-white bg-black/5 dark:bg-white/15 border border-black/10 dark:border-white/20 focus:border-black focus:dark:border-white"><svg class="absolute size-6 left-1.5 top-1/2 -translate-y-1/2 stroke-current"><use href="',
    '"></use></svg></div><!--$-->',
    "<!--/--></div>",
  ],
  _tmpl$2 = [
    "<div",
    ' class="mt-12"><div class="text-sm uppercase mb-2">Found <!--$-->',
    "<!--/--> results for <!--$-->",
...
function Search({ data }) {
  ...
  return ssr(
    _tmpl$,
    ssrHydrationKey(),
    ssrAttribute("value", escape(query(), true), false),
    `/ui.svg#search`,
    query().length >= 2 &&
      results().length >= 1 &&
      ssr(
...
const $$Index$2 = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/search/index.astro",
  void 0,
);
...
const $$Index$1 = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/work/index.astro",
  void 0,
);
...
const $$Index = createComponent(
  ...
  "/home/vmp/Projects/x50/src/pages/index.astro",
  void 0,
);
