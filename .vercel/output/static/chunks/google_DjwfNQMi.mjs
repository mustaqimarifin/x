...
const html =
  "<p>Sit amet consectetur adipisicing elit. Iure illo neque tempora, voluptatem est quaerat voluptas praesentium ipsa dolorem dignissimos nulla ratione distinctio quae maiores eligendi nostrum? Quibusdam, debitis voluptatum, lorem ipsum dolor.</p>\n<ul>\n<li>Aadipisicing elit. Iure illo neque tempora, voluptatem est.</li>\n<li>dolorem dignissimos nulla ratione.</li>\n<li>Quibusdam, debitis voluptatum, lorem ipsum dolor.</li>\n</ul>";
...
const file = "/home/vmp/Projects/x50/src/content/work/google.md";
const url = undefined;
function rawContent() {
