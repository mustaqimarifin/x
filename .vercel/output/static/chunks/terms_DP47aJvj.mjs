...
function getHeadings() {
  return [
    { depth: 4, slug: "agreement-to-terms", text: "Agreement to Terms" },
    {
      depth: 4,
      slug: "intellectual-property-rights",
      text: "Intellectual Property Rights",
    },
    { depth: 4, slug: "user-representations", text: "User Representations" },
    {
      depth: 4,
      slug: "links-to-other-websites",
      text: "Links to Other Websites",
    },
    { depth: 4, slug: "termination", text: "Termination" },
    { depth: 4, slug: "governing-law", text: "Governing Law" },
    {
      depth: 4,
      slug: "changes-to-these-terms-of-use",
      text: "Changes to These Terms of Use",
    },
  ];
}
